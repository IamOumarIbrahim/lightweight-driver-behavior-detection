...
\caption{Sixteen NIR protected-test results at seed 13 and deterministic 1-FPS midpoint sampling. Grouped columns compare all eight models at 1:2 and 1:6 training exposures; the dark-grey rule separates the ratio sections, and each thick red segment marks the eight-model mean for its ratio.}
\label{fig:nir}
\end{figure}
