...
<p align="center">
  ...
  <sub><b>Figure 4.</b> Sixteen NIR protected-test results at seed 13. Distinct colors identify all eight models at 1:2 and 1:6 training exposures; the dark-grey rule separates the ratio sections, and each thick black segment marks the arithmetic mean for its ratio.</sub>
</p>
