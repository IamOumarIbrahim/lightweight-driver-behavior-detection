...
Run scripts/data/05_build_nir_review_snippets.bat after frame preparation to create portable one-frame, 1-FPS local videos that match the benchmark sample used for Label Studio review.
